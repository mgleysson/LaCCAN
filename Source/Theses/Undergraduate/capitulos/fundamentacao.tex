...
\begin{equation}
    \widetilde{m}_{v} = \frac{d^{v}\phi_{Z}(s)}{ds^{v}}\Bigr|_{\substack{s=1}} \quad , \quad  v \in \mathbb{N}
    \label{eq:logmomV}
\end{equation}
...
\begin{equation}
    \widetilde{k}_{v} = \frac{d^{v}\psi_Z(s)}{ds^{v}}\Bigr|_{\substack{s=1}} \quad , \quad  v \in \mathbb{N}
    \label{eq:logcumV}
\end{equation}
