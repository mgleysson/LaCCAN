...
A solução proposta parte do pressuposto que há dados disponíveis em uma amostra $\bm z = (z_1, z_2, \dots, z_n)$ e um modelo para eles $D(\theta)$, com $\theta \in \Theta \subset \mathbb{R}^{p}$ o espaço paramétrico. 
