...
h1 <- ggplot(dados1, aes(y)) + geom_histogram(binwidth = 0.08, colour="black", fill="white") +
...
h2 <- ggplot(dados2, aes(y)) + geom_histogram(binwidth = 0.08, colour="black", fill="white") +
...
h3 <- ggplot(dados3, aes(y)) + geom_histogram(binwidth = 0.05, colour="black", fill="white") +
