...
qplot (xlab="Intensity", ylab="GI0 Densities") +
  ...
  geom_line(aes(hist1$mids,densd1), size=1.1, color="red") 
...
randVarGI0_3 <- randGI0_2(2000, -3, 2, 1)
...
qplot (xlab="Intensity", ylab="GI0 Densities") + 
  ...
  geom_line(aes(hist3$mids, densd3), size=1.1, color="red")

###########################################################################################

randVarGI0_4 <- randGI0_2(2000, -1.5, 0.5, 1)
...
qplot (xlab="Intensity", ylab="GI0 Densities") + 
  ...
  geom_line(aes(hist4$mids, densd4), size=1.1, color="red")

###########################################################################################

randVarGI0_5 <- randGI0_2(2000, -3, 4, 1)
...
qplot (xlab="Intensity", ylab="GI0 Densities") + 
  ...
  geom_line(aes(hist5$mids, densd5), size=1.1, color="red")
...
randVarGI0_8 <- randGI0_2(2000, -3, 4, 3)
...
qplot (xlab="Intensity", ylab="GI0 Densities") + 
  ...
  geom_line(aes(hist8$mids, densd8), size=1.1, color="red")

###########################################################################################

randVarGI0_9 <- randGI0_2(2000, -8, 7, 3)
...
qplot (xlab="Intensity", ylab="GI0 Densities") + 
  ...
  geom_line(aes(hist9$mids, densd9), size=1.1, color="red")
